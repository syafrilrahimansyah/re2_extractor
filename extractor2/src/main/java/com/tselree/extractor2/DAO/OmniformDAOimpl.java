...
public class OmniformDAOimpl implements OmniformDAO{
	...
	public Integer getNew() {
		try {
			String sql = "SELECT MIN(ID) FROM OMNIFORM WHERE STAGE = 'col'";
	...
	public String getPath(Integer id) {
		try {
			String sql = "SELECT PATH FROM OMNIFORM WHERE ID = '"+id+"'";
	...
	public void updateStage(Integer id) {
		String sql = "UPDATE OMNIFORM SET STAGE = 'ext' WHERE ID = '"+id+"'";
